            ...
            <Card variant="elevation" sx={{ maxWidth: '50%', maxHeight: '50%', backgroundColor: '#A35494', margin: 5, justifyContent: 'center', borderRadius: 5, padding: 3 }}>
                <CardHeader
                    ...
                    title={
                        <Grid container justifyContent="space-between" alignItems="flex-start">
                            ...
                            <Grid item>
                                <Typography variant="body2" sx={{ color: '#FFFFFF', marginLeft: -30, fontSize: '50%' }}>
                ...
                <CardContent sx={{ color: '#FFFFFF' }}>
                    <Grid container item xs={12} alignItems="center" spacing={2}>
                        ...
                        <Grid item xs={6}>
                            <TextField fullWidth variant="outlined" size="small" sx={{ backgroundColor: '#FFFFFF', borderRadius: 1 }} />
                        </Grid>
                    </Grid>
